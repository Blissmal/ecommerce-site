...
const QuickViewModal = () => {
    ...
    addItemOptimistic({
      ...
      discountedPrice:
        product.discount !== null
          ...
          : product.price,
      quantity: quantity,
      image: product.imageUrl, // Make sure this exists in your product object
      stock: product.stock,
    })
  );
  ...
  const previewImage = product?.imgs?.previews?.[activePreview];
...
/>
  ...
  <p className="text-sm text-red-500">No preview image available</p>
)}
                  </div>
                </div>
              </div>
