      ...
      <div className="max-w-screen-xl mx-auto px-6 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-8">
            ...
            <p className="text-dark-5 text-sm leading-relaxed max-w-xs">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 group cursor-pointer">
                ...
                <p className="text-sm text-dark-5 group-hover:text-dark transition-colors font-medium">Parklands Rd, Westlands</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-7">
            ...
            <ul className="space-y-4">
              {["Mobiles & Tablets", "Men's Shoes", "Women's Fashion", "Electronics", "New Arrivals"].map((link) => (
                <li key={link}>
                  <Link href="#" className="text-dark-5 hover:text-blue text-sm transition-all flex items-center gap-0 hover:gap-2 group">
          ...
          <div className="space-y-7">
            ...
            <p className="text-sm text-dark-5 leading-relaxed">Subscribe for exclusive offers and <span className="text-blue font-semibold">new arrivals</span>.</p>
            ...
            <div className="flex gap-3 pt-2">
              {['facebook', 'instagram', 'twitter', 'linkedin'].map((social) => (
                <a key={social} href="#" className="w-11 h-11 rounded-2xl border border-gray-2 flex items-center justify-center text-dark-5 hover:text-blue hover:border-blue hover:bg-blue/5 transition-all duration-300">
        ...
        <div className="pt-10 border-t border-gray-1 flex flex-col lg:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            ...
            <div className="flex gap-6">
               <Link href="#" className="text-[10px] font-bold text-dark-5 hover:text-blue transition-colors uppercase tracking-widest">Privacy</Link>
               <Link href="#" className="text-[10px] font-bold text-dark-5 hover:text-blue transition-colors uppercase tracking-widest">Terms</Link>
            </div>
          </div>

          {/* Payment Badges - Styled to match the Hero tags */}
          <div className="flex items-center gap-3">
            <span className="text-[10px] font-bold text-dark-5 uppercase tracking-widest mr-2">Secure Payments:</span>
