  ...
  return (
    <footer className="overflow-hidden border-t border-gray-3">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        {/* <!-- footer menu start --> */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-18 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <Image
              ...
              className="mb-7.5"
            />
            <span className="flex items-center gap-2.5 mb-7.5">
              <Image
                src="/kenya.svg"
                alt="footer logo"
                width={30}
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                Parklands Road, Westlands, Nairobi, Kenya.
              </li>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year} Hustlesasa. All rights reserved.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a href="#">
                <p className="font-medium">Refunds & Returns</p>
              </a>
