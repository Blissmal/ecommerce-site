...
const OrderModal = ({ showDetails, showEdit, toggleModal, order }: any) => {
  ...
  return (
    <>
      ...
      >
        <div className="shadow-7 relative w-full max-w-[600px] max-h-[90vh] overflow-hidden scale-100 transform rounded-[15px] bg-white transition-all flex flex-col justify-center items-center">
          <button
