        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className={cardStyle}>
              <button type="submit" disabled={loading} className="w-full py-4 bg-blue text-white rounded-xl font-bold shadow-2 hover:bg-blue-dark transition-all disabled:opacity-50 mb-3 flex items-center justify-center gap-2">
                {loading ? (
            ...
            <section className={cardStyle}>
              ...
              <div className="space-y-4">
                <div>
                  <label className={labelStyle}>Main Image URL <span className="text-red">*</span></label>
                  <input type="url" value={imageUrl} onChange={(e) => setImageUrl(e.target.value)} className={inputStyle} required placeholder="https://..." />
